import { NavSpan, NavForm, NavButton, NavImage, NavInput, NavSVG, NavModalFormSearch } from "../../atoms/Navbar";
...
export const ModalButtonBack = ({ onBack }) => {
    return (
      <div className="nav__modal_mobile_top">
        <NavButton type="button" className="nav__modal_button-back" onClick={onBack}>
          <NavImage
