...
// Nav Input Atom
export const NavInput = ({ className , type, placeholder, name, autoComplete }) => {
...
export const NavModalSearchInput = ({ type, placeholder, name, autoComplete, value }) => {
  const [inputValue, setInputValue] = useState('');
...
// Nav SVG Atom
export const NavSVG = ({ xmlns, width, height, viewBox, fill, className, path }) => {
    return (
  <svg
    xmlns={xmlns}
    width={width}
